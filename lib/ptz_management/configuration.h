...
namespace ONVIF {
    class Configuration : public QObject
    {
        ...
        Q_PROPERTY(QString defaultAbsolutePanTiltPositionSpace READ defaultAbsolutePanTiltPositionSpace WRITE setDefaultAbsolutePanTiltPositionSpace)          // GREPTAG000
