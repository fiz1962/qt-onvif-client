...
StreamUri *MediaManagement::getStreamUri(int nProfile)
{
    StreamUri *streamUri = NULL;
    QDomElement profileToken = newElement("ProfileToken", getProfiles()->m_toKenPro[nProfile]);
    ...
    QDomElement tunnel = newElement("Tunnel");
